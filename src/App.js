...
class App extends Component {
  ...
  getWeatherData({dep, arr}) {
    ...
    const getWeaDep = () => {
      const reURL = `//api.apixu.com/v1/forecast.json?key=${API_KEY_APIXU}&q=${dep.lat},${dep.long}&days=100`;
      return axios.get(reURL);
    }

    const getWeaArr = () => {
      const reURL = `//api.apixu.com/v1/forecast.json?key=${API_KEY_APIXU}&q=${arr.lat},${arr.long}&days=100`;
      return axios.get(reURL);
    }
      ...
      <div className="App">
        ...
        <footer className="footer-area">
          <div className="container">
            <div className="row justify-content-md-center">
              <div className="col-md-8">
                <ul className="made list-inline">
                  <li className="list-inline-item">React</li>
                  <li className="list-inline-item">Axios</li>
                  <li className="list-inline-item">Love</li>
                </ul>
                <ul className="made-by list-inline">
                  <li className="list-inline-item">Mahen Mondal</li>
                  <li className="list-inline-item">Sagar Neupane</li>
                  <li className="list-inline-item">Zonayed Ahmed</li>
                </ul>
                <ul className="list-inline">
                  <li className="list-inline-item"><small><a className="github-button" href="https://github.com/zonayedpca/civilAviationWeatherApp/subscription" data-icon="octicon-eye" aria-label="Watch zonayedpca/civilAviationWeatherApp on GitHub">Watch</a></small></li>
                  <li className="list-inline-item"><small><a className="github-button" href="https://github.com/zonayedpca/civilAviationWeatherApp" data-icon="octicon-star" aria-label="Star zonayedpca/civilAviationWeatherApp on GitHub">Star</a></small></li>
                  <li className="list-inline-item"><small><a className="github-button" href="https://github.com/zonayedpca/civilAviationWeatherApp/fork" data-icon="octicon-repo-forked" aria-label="Fork zonayedpca/civilAviationWeatherApp on GitHub">Fork</a></small></li>
                </ul>
              </div>
            </div>
          </div>
